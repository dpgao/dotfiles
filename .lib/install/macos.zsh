...
MENU_DIR=/System/Library/CoreServices/Menu\ Extras
open $MENU_DIR/VPN.menu
open $MENU_DIR/Volume.menu
open $MENU_DIR/Bluetooth.menu
...
defaults write -app Mail FullScreenPreferSplit -bool false
